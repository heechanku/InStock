...
function InventoryRow({ id, name, category, status, quantity, onDelete, onEdit }) {
  ...
  return (
    <div className="inventory-row">
      <div className="inventory-row__col inventory-row__col--name">
        ...
        <img className="inventory-row__icon" src={chevronRightIcon} alt="open" />
      </div>
      ...
      <div className=" inventory-row__col--actions">
        ...
        <button className="inventory-row__icon-button inventory-row__icon-button--edit" onClick={onEdit}>
